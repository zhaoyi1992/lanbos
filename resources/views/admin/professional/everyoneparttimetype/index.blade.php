        ...
        <form id="role-form">
            <div class="select-list">
                <ul>
                    ...
                    <li>分类名称：<input type="text" name="like[name]"></li>
                    <li>国家：
                        <select name="where[country]" class="select2" data-width="150px">
                            <option value="">全部</option>
                            @foreach($type as $value)
                                <option value="{{$value['poskey']}}">{{$value['name']}}</option>
                            @endforeach
                        </select>
                    <li>
                    <li>分类状态：
        ...
        $(function () {
            var options = {
                ...
                columns: [
                    ...
                    {field: 'countryvalue', title: '国家', align: 'center'},
                    {field: 'name', title: '分类名称', align: 'center'},
                    {field: 'poskey', title: '分类编码', align: 'center'},
