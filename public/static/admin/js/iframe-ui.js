    ...
    $.extend({
        ...
        operate: {
            ...
            removeAlllink: function(obj) {
                ...
                $.modal.confirm("确认要清空选中的" + rows.length + "条号码数据吗?", function() {
                    var url = table.options.removeAllUrllink;
                    var data = { "ids": rows.join() };
                    $.operate.submit(url, "post", "json", data);
                });
            },
            ...
            addlinks: function(obj) {
                ...
                console.log(table.options.addlinkUrl)

                $.modal.open("批量分配号码" , table.options.addlinkUrl,width,height);
            },
            // 导入
            // 导入数据
